...
export default function Projects() {
  ...
  return (
    <section id="projects" className="section-padding relative">
      <div className="absolute top-1/3 -left-32 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[128px]" />
      <div className="absolute bottom-1/3 -right-32 w-[500px] h-[500px] bg-accent/5 rounded-full blur-[128px]" />
            ...
            >
              ...
              >
                <div className="flex flex-col lg:flex-row">
                  {/* Project visual */}
                  <div className={`relative lg:w-2/5 h-56 lg:h-auto bg-gradient-to-br ${project.gradient}
